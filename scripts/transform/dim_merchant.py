...
if df.empty:
    print("Warning: Empty merchant_data for dim_merchant. Creating empty output.")
    pd.DataFrame().to_parquet("/dataset/transformed/dim_merchant.parquet", index=False)
    print("[SUCCESS] dim_merchant completed (empty)")
    exit(0)
