...
if df.empty:
    print("Warning: Empty user_data. Creating empty output.")
    pd.DataFrame().to_parquet('/dataset/transformed/user_data.parquet', index=False)
else:
...
print("[SUCCESS] transform_customer_management completed")
