...
campaign_data = glob.glob('/dataset/Marketing Department/campaign_data*')
...
transactional_campaign_data = glob.glob('/dataset/Marketing Department/transactional_campaign_data*')
...
df.to_parquet('transactional_campaign_data.parquet')